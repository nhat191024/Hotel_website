...
@section('main')
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Promotion Manager</h1>
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <a class="btn btn-primary" href="{{ route('admin.promotion.show_add') }}">Add Promotion</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($promotions as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->title }}</td>
                                        <td>
                                            <img src="{{ asset($item->image) }}" alt="promotion" width='150px'>
                                        </td>
                                        <td>{{ $item->link }}</td>
                                        <td>
                                            @if ($item->status == 1)
